...
<form name="feedback" method="post" action="RegistrationLogic.php">
    <label>Имя <input type="text" name="userName"value="<?php echo isset($_COOKIE['userName']) ? $_COOKIE['userName'] : ''?>"></label>
    ...
    <form name="file_upload" method="post" action="RegistrationLogic.php" enctype="multipart/form-data">
